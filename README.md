# hse23_project
## Отчётность: групповая часть
Презентации группы, таблица с -log(E-value) и код, использованный для построения тепловой карты, находятся в папке data.


## Общее описание проекта
Целью работы над проектом является изучение методами сравнительной геномики ранней эволюции белков, выполняющих эпигенетические модификации H3K4me и взаимодействующих с ними в клетках человека. Далее приведены некоторые выдержки из презентаций.
